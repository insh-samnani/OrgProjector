                ...
                {props.workitem.backlogitems && props.workitem.backlogitems.map((workitemm) => {
                        return <div key={workitemm._id}>
                            <div style = {{flex: "1", display: "flex", flexDirection: "row"}}>
                                ...
                                <div style = {{flex: "1"}}>
                                    <button style = {{marginTop: "30px", width: "100px"}} type="button" className="btn btn-dark" data-bs-toggle="modal" data-bs-target="#exampleModal6" onClick={() => handleUpdateClick(workitemm._id)}>Update</button>
                                    {
